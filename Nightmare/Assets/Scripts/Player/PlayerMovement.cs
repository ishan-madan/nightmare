...
public class PlayerMovement : MonoBehaviour
{
	...
	void Awake(){
		...
		anim = GetComponent<Animator>(); // sets anim to be the animator controller on the player
	...
	void Animating(float h, float v){
		...
		anim.SetBool("IsWalking", walking); // sets the AC condition of IsWalking to true or false depending on the value of the "walking" variable
	}
}
